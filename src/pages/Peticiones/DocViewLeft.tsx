          ...
          <CardContent>
            <Box sx={{ pt: 0, pb: 7 }}>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Typography variant='body2'>@{doc.authorDocument.name}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                  Correo Electronico:
                </Typography>
                <Typography variant='body2'>{doc.authorDocument.email}</Typography>
              </Box>
              ...
              <Box sx={{ display: 'flex', mb: 2.7 }}>
                <Typography sx={{ mr: 2, fontWeight: 500, fontSize: '0.875rem' }}>Telefono:</Typography>
                <Typography variant='body2'>{doc.authorDocument.phone}</Typography>
              </Box>
              <Box sx={{ display: 'flex', mb: 2.7 }}>
