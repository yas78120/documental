...
const DocList = () => {
  ...
  const fetchDataFromServer = async () => {
    ...
    try {
      setEndPoint('OBTAIN%20DOCUMENTS%20SEND%20WITH%20WORKFLOW')

      const response = await axios.get(
        `http://localhost:3501/documents/get-all-table-paginate?view=OBTAIN%20DOCUMENTS%20SEND%20WITH%20WORKFLOW&page=${currentPage}&limit=${pageSize}`
      )
