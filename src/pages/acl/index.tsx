...
const DocViewLeft = () => {
  ...
  const viewDoc = async (id: string) => {
    console.log(id)
    await axios
      .get<Docu[]>(`${process.env.NEXT_PUBLIC_DOCUMENTAL}${id}`)
      .then(response => {
        //setaa(response.data)
            ...
            <CardContent>
              ...
              <Box sx={{ pt: 2, pb: 1 }}>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>@{aa.username}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Billing Email:
                  </Typography>
                  <Typography variant='body2'>{aa.email}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  <Typography variant='subtitle2' sx={{ mr: 2, color: 'text.primary' }}>
                    Status:
                ...
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                  ...
                  <Typography variant='body2'>+1 {aa.contact}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 2.7 }}>
                ...
                <Box sx={{ display: 'flex' }}>
                  ...
                  <Typography variant='body2'>{aa.country}</Typography>
                </Box>
              </Box>
            </CardContent>
                ...
                <form>
                  <Grid container spacing={6}>
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Full Name' defaultValue={aa.fullName} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                        label='Username'
                        defaultValue={aa.username}
                        InputProps={{ startAdornment: <InputAdornment position='start'>@</InputAdornment> }}
                      />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth type='email' label='Billing Email' defaultValue={aa.email} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Contact' defaultValue={`+1 ${aa.contact}`} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
